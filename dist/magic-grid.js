...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return MagicGrid; });
...
function () {
  ...
  function MagicGrid(config) {
    ...
    Object(_utils__WEBPACK_IMPORTED_MODULE_1__["checkParams"])(config);
  ...
  _createClass(MagicGrid, [{
    ...
    value: function _setup() {
      ...
      var numCols = Math.floor(width / this._colWidth()) || 1;
      var cols = [];
      ...
      var wSpace = width - numCols * this._colWidth() + this.gutter;
      return {
        cols: cols,
        wSpace: wSpace
      };
    ...
    key: "_nextCol",
    value: function _nextCol(cols, i) {
      if (this.useMin) {
        return Object(_utils__WEBPACK_IMPORTED_MODULE_1__["getMin"])(cols);
      }
    ...
    value: function positionItems() {
      ...
      self.item.each(function (i) {
        ...
        var left = min.index * self._colWidth() + wSpace;
        var $item = self.$(this);
        $item.css({
          left: left + "px",
      ...
      self.container.css({
        height: Object(_utils__WEBPACK_IMPORTED_MODULE_1__["getMax"])(cols).height
      });
    }
    /**
