...
var Listener = /*#__PURE__*/ _createClass(
  function Listener(id, event, handler) {
      ...
      value: function addListener(event, handler) {
        ...
        var id =
          (_classPrivateFieldSet2(
            _idCounter,
            this,
            ((_this$idCounter = _classPrivateFieldGet2(_idCounter, this)),
            (_this$idCounter2 = _this$idCounter++),
            _this$idCounter)
          ),
          _this$idCounter2);
...
//# sourceMappingURL=magic-grid.cjs.js.map
